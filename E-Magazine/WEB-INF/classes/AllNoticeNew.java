...
import java.sql.*;
public class AllNoticeNew extends HttpServlet
{
...
pw.println("<title>Events Gallery</title>");
...
RequestDispatcher rd=req.getRequestDispatcher("../Sidebar.html");
       ...
       pw.println("<div class=\"scroll\">");
		  ...
		  pw.println(" <table align=\"center\" width=\"444\" border=\"0\">");
                 pw.println(" <tr>");
                   pw.println(" <td align=\"center\" colspan=\"3\"><h1>ALL NOTICES</h1></td>");
                  pw.println("</tr>");
		  pw.println("<table>");
		  Connection con=DBInfo.getConnection();
		   String query="select * from noticeinfo";
               ...
               pw.println(" <table align=\"center\" width=\"444\" border=\"0\">");
                 ...
                 pw.println(" <tr>");
                  ...
                  /*pw.println("<tr>");
                   ...
                   pw.println("<td width=\"157\" align=\"center\"><a href=\"../servlet/Comment\"><img src=\"../images/comment.png\" width=\"148\" height=\"150\"  /></a></td>");
				       */
