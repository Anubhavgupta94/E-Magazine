...
import java.sql.*;
public class AlumniSection extends HttpServlet
{
	...
	pw.println("<div id=\"tooplate_wrapper\">");
     ...
     pw.println("<div class=\"scroll\">");
		  ...
		  pw.println("<table width=\"496\" height=\"315\" border=\"0\" align=\"center\">");
			pw.println("<tr>");
			pw.println(" <td width=\"490\" height=\"75\" align=\"center\"><h1>ALUMNI SECTION</h1></td>");
		  pw.println("</tr>");
			

			 pw.println("<tr>");
			pw.println(" <td height=\"40\"><a href=\"PostArticleAlumni\">Post an Article</a></td>");
			pw.println(" </tr>");
			pw.println("<tr>");
         ...
         pw.println(" <tr>");
		  ...
		  pw.println("</tr>");
			...
			pw.println("</tr>");
			//pw.println("<tr>");
			// pw.println("<td height=\"34\"><a href=\"UpdateAlumniInfo\">Update Profile</a></td>");
			//pw.println("</tr>");
			pw.println("<tr>");
