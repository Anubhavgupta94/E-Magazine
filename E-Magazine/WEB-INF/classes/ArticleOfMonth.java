...
import java.sql.*;
public class ArticleOfMonth extends HttpServlet
{
...
pw.println("<title>Article of Month</title>");
	...
	pw.println("<div id=\"tooplate_wrapper\">");
       ...
       pw.println("<div class=\"scroll\">");
		  ...
		  pw.println(" <table align=\"center\" width=\"444\" border=\"0\">");
                 pw.println(" <tr>");
                   pw.println(" <td align=\"center\" colspan=\"3\"><h1><strong>ARTICLE OF MONTH</strong></h1></td>");
                  pw.println("</tr>");
		  pw.println("<table>");
