...
public class Delete extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException, ServletException
	{
		...
		{	
			...
			/*String query1="delete from alumnirecord where id=?";
			String query2="delete from facultyrecord where id=?";
			String query3="delete from studentrecord where id=?";
			String query4="delete from othersrecord where id=?";
			String query5="delete from alumnirecord where id=?";*/
