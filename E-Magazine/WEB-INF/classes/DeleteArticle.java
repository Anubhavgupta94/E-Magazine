...
public class DeleteArticle extends HttpServlet
{
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException, ServletException
	{
		...
		{	
			...
			String query="delete from articleinfo where no=?";
			...
			pw.println("<title>Delete Article</title>");
 ...
 pw.println("<center>");
pw.println("<h1>ARTICLE DELETED</h1>");
 pw.println("<BR><a href=AllArticle>BACK</a>");
 pw.println("</center>");
 pw.println("</div>");
