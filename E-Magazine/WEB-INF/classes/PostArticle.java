         ...
         pw.println("<table align=\"center\" width=\"497\" border=\"0\">");
           ...
           pw.println("<tr>");
            pw.println(" <td width=\"81\">Class</td>");
			 ...
			 pw.println(" <td colspan=\"2\"><a href=\"../ArticleAddClass.html\">if other</a>");
           ...
           pw.println("<tr>");
            pw.println(" <td>Category</td>");
             ...
             pw.println("<td colspan=\"2\"><a href=\"../ArticleAddCategory.html\">if other</a>");
           ...
           pw.println("<tr>");
			...
			pw.println("<td colspan=\"2\"><a href=\"../ArticleAddType.html\">if other</a>");
