...
import java.sql.*;
public class PostArticleAlumni extends HttpServlet
{
...
public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException, ServletException
  ...
  HttpSession session=req.getSession();
      ...
      pw.println(" <form method=post>");
         pw.println("<table align=\"center\" width=\"497\" border=\"0\">");
           ...
           pw.println("<tr>");
            pw.println(" <td width=\"81\">Class</td>");
			 ...
			 pw.println(" <td colspan=\"2\"><a href=\"../ArticleAddClassAlumni.html\">if other</a>");
           ...
           pw.println("<tr>");
            pw.println(" <td>Category</td>");
             ...
             pw.println("<td colspan=\"2\"><a href=\"../ArticleAddCategoryAlumni.html\">if other</a>");
           ...
           pw.println("<tr>");
			...
			pw.println("<td colspan=\"2\"><a href=\"../ArticleAddTypeAlumni.html\">if other</a>");
         ...
         pw.println("</table>");
       pw.println("</form>");
	   pw.println("<BR><a href=AlumniSection>BACK</a>");
	   pw.println("</center>");
      pw.println("</div>");
...
public void doPost(HttpServletRequest req,HttpServletResponse res) throws IOException, ServletException
  {	
		...
		res.sendRedirect("PostArticleAlumni");
}
}