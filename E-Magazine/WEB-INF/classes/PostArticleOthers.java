...
import java.sql.*;
public class PostArticleOthers extends HttpServlet
{
...
public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException, ServletException
  ...
  HttpSession session=req.getSession();
      ...
      pw.println(" <form method=post>");
         pw.println("<table align=\"center\" width=\"497\" border=\"0\">");
           ...
           pw.println("<tr>");
            pw.println(" <td width=\"81\">Class</td>");
			 ...
			 pw.println(" <td colspan=\"2\"><a href=\"../ArticleAddClassOthers.html\">if other</a>");
           ...
           pw.println("<tr>");
            pw.println(" <td>Category</td>");
             ...
             pw.println("<td colspan=\"2\"><a href=\"../ArticleAddCategoryOthers.html\">if other</a>");
           ...
           pw.println("<tr>");
			...
			pw.println("<td colspan=\"2\"><a href=\"../ArticleAddTypeOthers.html\">if other</a>");
         ...
         pw.println("</table>");
       pw.println("</form>");
	   pw.println("<BR><a href=OthersSection>BACK</a>");
	   pw.println("</center>");
      pw.println("</div>");
  ...
  {	
		...
		res.sendRedirect("PostArticleOthers");
}
}