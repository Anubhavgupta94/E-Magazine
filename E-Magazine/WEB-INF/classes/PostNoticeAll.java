...
import java.sql.*;
public class PostNoticeAll extends HttpServlet
{
  ...
  HttpSession session=req.getSession();
		  ...
		  String pass3=(String) session.getAttribute("pass3");
			...
			pw.println("<title>Post Notice Page</title>");
      ...
      pw.println(" <form method=post>");
         pw.println("<table align=\"center\" width=\"444\" border=\"0\">");
           pw.println("<tr>");
             pw.println("<td align=\"center\" colspan=\"4\"><h1>FILL NOTICE INFORMATION</h1></td>");
           pw.println("</tr>");
		   
		    ArrayList<String> obj=GetNoticeClass.getType();
           pw.println("<tr>");
            pw.println(" <td width=\"81\">Class</td>");
			 ...
			 pw.println(" <td colspan=\"2\"><a href=\"../NoticeAddClass.html\">if other</a>");
            pw.println(" <label for=\"otherclass\"></label></td>");
			 
           pw.println("</tr>");
		   
		   ArrayList<String> obj1=GetNoticeCategory.getType();
           pw.println("<tr>");
            pw.println(" <td>Category</td>");
             ...
             pw.println("<td colspan=\"2\"><a href=\"../NoticeAddCategory.html\">if other</a>");
             pw.println("<label for=\"othercategory\"></label></td>");
			 
           pw.println("</tr>");
		   
		   ArrayList<String> obj2=GetNoticeType.getType();
           pw.println("<tr>");
			...
			pw.println("<td colspan=\"2\"><a href=\"../NoticeAddType.html\">if other</a>");
         ...
         pw.println("</table>");
       pw.println("</form>");
	   pw.println("<BR><a href=../ConfirmAccount.html>BACK</a>");
	   pw.println("</center>");
      pw.println("</div>");
  ...
  {	
		PrintWriter pw=res.getWriter();
		  ...
		  String query="insert into noticeinfo values(?,?,?,?,?,?)";
