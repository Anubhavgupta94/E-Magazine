...
import java.sql.*;
public class ShowContactForm extends HttpServlet
{
...
pw.println("<title>ContactUs Info Page</title>");
...
RequestDispatcher rd=req.getRequestDispatcher("../Sidebar.html");
       ...
       pw.println("<div class=\"scroll\">");
		  ...
		  pw.println(" <table align=\"center\" width=\"444\" border=\"0\">");
                 pw.println(" <tr>");
                   pw.println(" <td align=\"center\" colspan=\"3\"><h1><strong>ALL QUERIES</strong></h1></td>");
                  pw.println("</tr>");
		  pw.println("<table>");
